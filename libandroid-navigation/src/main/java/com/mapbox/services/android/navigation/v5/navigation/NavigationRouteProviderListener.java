...
class NavigationRouteProviderListener implements RouteListener {
  ...
  NavigationRouteProviderListener(NavigationEventDispatcher eventDispatcher, FasterRoute fasterRouteEngine) {
