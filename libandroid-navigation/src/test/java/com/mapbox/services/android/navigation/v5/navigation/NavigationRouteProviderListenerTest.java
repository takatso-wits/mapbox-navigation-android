...
public class NavigationRouteProviderListenerTest {
  ...
  public void onResponseReceived_fasterRouteIsSentToDispatcher() {
    ...
    NavigationRouteProviderListener listener = new NavigationRouteProviderListener(eventDispatcher, fasterRoute);
